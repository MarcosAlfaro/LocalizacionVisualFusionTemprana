...
# valDataset = exp1_create_datasets.Validation_RGBd()
# valDataloader = DataLoader(valDataset, shuffle=False, num_workers=0, batch_size=1)


"""NETWORK TRAINING"""

with open(f"{csvDir}/Exp_COLD_Train.csv", 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(["Features", "Iteration", "R@1 Cloudy", "R@1 Night", "R@1 Sunny", "R@1 Avg."])

    lossFunction = "lazy triplet"
    margin = 0.5

    baseModelDir = create_path("/home/arvc/Marcos/INVESTIGACION/0_SAVED_MODELS/JA_2025/EXP_COLD/")
    ...
    for features in featuresList:
        ...
        vmDataset = create_datasets_cold.VisualModel(features=features)
        ...
        trainDataset = create_datasets_cold.Train(features=features)
